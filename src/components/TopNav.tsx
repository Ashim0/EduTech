    ...
    return (
        <div className="hidden border-b border-slate-200/80 bg-[#0b3d91] backdrop-blur-sm md:block">
            <div className="mx-auto flex w-[min(1400px,92vw)] items-center justify-end gap-4 py-2 lg:gap-8 px-4 text-xs sm:text-sm">
                ...
                <a
                    className="hidden font-medium text-white/40 cursor-not-allowed lg:block"
                    href="#"
                    aria-disabled="true"
                >
                    Counselor Login
                ...
                <button
                    disabled
                    className="inline-flex items-center justify-center gap-2 rounded-md border border-slate-500 px-2 py-1 lg:px-3 font-semibold text-white/40 cursor-not-allowed"
                >
